---
title: CRM connectors for Salesforce, HubSpot, and more
description: Sync contacts, accounts, deals, and activity from Salesforce, HubSpot, and other CRMs. Map fields, schedule sync, and resolve duplicate records.
---
