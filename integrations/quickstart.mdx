---
title: Integrations quickstart for first-time setup
sidebarTitle: Quickstart
description: Connect your first integration in under 10 minutes. Authenticate a source, map data, run a test sync, and monitor events from the integrations dashboard.
---
