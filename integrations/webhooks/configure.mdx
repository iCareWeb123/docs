---
title: Configure webhooks for event notifications
description: Register a webhook endpoint, subscribe to specific event types, verify signatures, and handle retries to receive reliable real-time notifications.
---
...
<Steps>
  ...
  <Step title="Select events">
    ...
    See the event types reference for the full list and payload schemas. {/* TODO: Restore link once /integrations/webhooks/event-types page exists. */}
  </Step>
