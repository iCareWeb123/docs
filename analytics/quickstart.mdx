---
title: Analytics quickstart for new workspaces
sidebarTitle: Quickstart
description: Get started with Analytics by connecting a data source, building your first dashboard, and sharing reports with teammates in under 15 minutes.
---
...
- Explore charts and visualizations to learn about all available chart types. {/* TODO: Restore link once /analytics/dashboards/charts-visualizations page exists. */}
