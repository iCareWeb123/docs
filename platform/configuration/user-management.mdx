---
title: Invite, deactivate, and manage workspace users
description: Add team members by email or SSO, bulk import users from CSV, assign roles, deactivate accounts, and audit user activity from a single admin panel.
---
