---
title: Roles and permissions for workspace access control
description: Assign built-in roles, create custom roles, and scope permissions across workspaces and projects to control who can view, edit, and admin resources.
---
